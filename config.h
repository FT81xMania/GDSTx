	...
	#define SizeEVE              54  //5//54//43   // NHD: 7-7",  5-5", 43-4.3", 35-3.5", Riverdi: 51-5", 71-7", MO: 38-3.8"FT813, MO: 52-5"BT815, MO: 53-5"FT813, Riverdi: 54-5"  BT817, 0 Riverdi FT801/FT800 4.3", Riverdi: 100-10" BT817
                                     // 431-EVE3x-43 MO   Riverdi: 74-7"  BT817     434,  Riverdi BT817 4.3"     0     FT801
  ...
  #define SD_PIN 			 	 5   //under test
	...
	#define ORIENTACION     	 1   // 0, 1, 2, 3, FT81X/BT81X   0 normal  
	#define ROTACION        	 0   // 0,1         FT80x
