	...
	#define SizeEVE              100   // 431-EVE3x-43 MO   Riverdi: 74-7"  BT817     434,  Riverdi BT817 4.3"     0     FT801
	...
	#define NHDTouch 		     1   // 1 cargar rutinas panel táctil: Riverdi BT817 5"   0 NHD normal aparentemente no lo requiere?¿:  NHD5
	#define GameduinoX           0   // 1 gameduinox shield instalado  0 otros como NHD43 o FT843   FT801
#endif

//5018553770552R00068681

#if defined(ARDUINO_ARCH_STM32) 

    #define STM32_CPU          4073//4073//446   //746   // 103-M3DEMO-F103C8, 767-NucleoF767, 411-F411CE,  746-Core7XXI,  4073-M4DEMO-F407VG   STM32-Danieleff and SdFatV2       7670-CoreOfficialSTM32-v190  7460-CoreOfficialSTM32-v190
                                           // 446-F446RE DanieleffCore   4074-F407VG STM32-OfficialCore
	#define SizeEVE      	     43 //5   //53    // NHD: 7-7",  5-5", 43-4.3", 35-3.5", Riverdi: 51-5", 71-7", MO: 38-3.8"FT813, MO: 52-5"FT813, MO: 53-5"BT815, Riverdi: 54-5"  BT817, 0 Riverdi FT801/FT800 4.3", Riverdi: 100-10" BT817
	#define ORIENTACION     	 0   // 0, 1, 2, 3, FT81X/BT81X   0 normal  1-MO38
	#define ROTACION        	 0   // 0,1         FT80x
	
	#define CS 			       PA4   // general
	#define SetSPISpeed   36000000   // general
	#define NHDTouch 		     0  // 1 cargar rutinas panel táctil    0 NHD normal aparentemente no lo requiere?¿ usar en STM32 cuando falle EEPROM externa
  ...
  #define SD_PIN 			 	 5   //under test
	...
	#define SizeEVE              43   // NHD: 7-7",  5-5", 43-4.3", 35-3.5", Riverdi: 51-5", 71-7", MO: 38-3.8"FT813, MO: 52-5"BT815, MO: 53-5"FT813, Riverdi: 54-5"  BT817, 0 Riverdi FT801/FT800 4.3", Riverdi: 100-10" BT817
